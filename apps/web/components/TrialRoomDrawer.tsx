...
export function TrialRoomDrawer({
  isOpen,
  onClose,
  avatars,
  activeAvatarId,
  ...
  const [activeTab, setActiveTab] = useState<"fitting" | "plates" | "history">("fitting");
    ...
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 z-50 overflow-hidden">
          ...
          <motion.aside
            role="dialog"
            aria-label="Trial Room & Fitting Studio"
          ...
          >
            ...
            <div className="flex shrink-0 items-center justify-between border-b-[3px] border-[#12100d] bg-white px-5 py-3.5 shadow-[0px_3px_0px_#12100d]">
              ...
              <div className="flex items-center gap-2">
                <Link
                  href="/look"
                  className="border-2 border-[#12100d] bg-[#FFDE59] px-3 py-1 font-mono text-xs font-black uppercase text-[#12100d] shadow-[2px_2px_0px_#12100d] hover:bg-[#FFE57F] transition-all"
                >
                  FULL TRIAL ROOM ↗
                </Link>
                <button
            ...
            <div className="flex shrink-0 items-center gap-2 border-b-[3px] border-[#12100d] bg-[#F4EFE6] p-3">
              {[
                { key: "fitting", label: "⚡ LIVE TRIAL FITTING" },
